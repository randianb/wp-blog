...
/* themes/uikit/templates/navigation/links.html.twig */
class __TwigTemplate_ce0b775b2c47fd480a0feaea8d27f9658efdbd4a8cfd880f08142c77965e54ce extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ((isset($context["links"]) ? $context["links"] : null)) {
            ...
            // line 44
            echo "<ul";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "uk-list"), "method"), "html", null, true));
            echo ">";
            // line 45
...
$context["item"], "text_attributes", array())) {
    ...
    {
        return "themes/uikit/templates/navigation/links.html.twig";
    }
...
/**
 * @file
 * Theme override to display a set of links.
 *
 * Available variables:
...
{% if links -%}
  {%- if heading -%}
    ...
    {%- endif -%}
  {%- endif -%}
  <ul{{ attributes. addClass('uk-list') }}>
    {%- for item in links -%}
      <li{{ item.attributes }}>
        {%- if item.link -%}
          {{ item.link }}
